...
public class StateRestController {
 ...
 public ResponseEntity<State> createState(@RequestBody State state, @PathVariable
Long country_id) {
 ...
 public ResponseEntity<List<State>> getStatesByCountry(@PathVariable Long
countryId) {
 List<State> states = stateService.listStatesByCountry(countryId);
 return new ResponseEntity<>(states, HttpStatus.OK);
 }
 @PutMapping
 public ResponseEntity<State> updateState(@RequestBody State state, @PathVariable
Long country_id) {
